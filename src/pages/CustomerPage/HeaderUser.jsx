  ...
  render() {
    ...
    return (
      <div className="row payment-navigation">
        <div
          className={`col-6 col-md-3 nav-item ${selectedItem === 'cart' ? 'active' : ''}`}
        ...
        <div
          className={`col-6 col-md-3 nav-item ${selectedItem === 'info' ? 'active' : ''}`}
        ...
        <div
          className={`col-6 col-md-3 nav-item ${selectedItem === 'payment' ? 'active' : ''}`}
        ...
        <div
          className={`col-6 col-md-3 nav-item ${selectedItem === 'address' ? 'active' : ''}`}
