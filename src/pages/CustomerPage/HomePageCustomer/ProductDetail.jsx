      ...
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <table className="k table-bordered table-responsive">
            <tbody>
              <tr>
                <td className="p"><strong>Nghệ nhân:</strong></td>
                <td className="t">{product.artist}</td>
              </tr>
              <tr>
                <td className="p"><strong>Giá trị:</strong></td>
                <td className="t">${product.price}</td>
              </tr>
              <tr>
                <td className="p"><strong>Phân loại:</strong></td>
                <td className="t">{product.type}</td>
              </tr>
              <tr>
                <td className="p"><strong>Danh mục:</strong></td>
                <td className="t">{product.category}</td>
              </tr>
              <tr>
                <td className="p"><strong>Số lượng:</strong></td>
                <td className="t">{product.quantity}</td>
              </tr>
              <tr>
                <td className="p"><strong>Chiều cao:</strong></td>
                <td className="t">{product.detail.height} cm</td>
              </tr>
              <tr>
                <td className="p"><strong>Khối lượng:</strong></td>
                <td className="t">{product.detail.weight} kg</td>
              </tr>
              <tr>
                <td className="p"><strong>Chiều dài:</strong></td>
                <td className="t">{product.detail.length} cm</td>
              </tr>
              <tr>
                <td className="p"><strong>Ngày sản xuất:</strong></td>
                <td className="t">{product.detail.date}</td>
              </tr>
              <tr>
                <td className="p"><strong>Mã sản phẩm:</strong></td>
                <td className="t">{product.detail.idProduct}</td>
              </tr>
              <tr>
                <td className="p"><strong>Mô tả:</strong></td>
                <td className="t">{product.description}</td>
              </tr>
            </tbody>
          </table>
          <Link to="#" onClick={() => window.history.back()} className="btn btn-primary">
            Xem sản phẩm khác
          </Link>
        </div>
      </div>
